// Type definitions for vscode-elements
// This file helps TypeScript understand the custom elements from @vscode-elements/elements
...
// Allow arbitrary additional props (like `appearance`, `slot`, `value`,
// `onInput` with non-standard Event types, and kebab-cased data attributes)
type ElementProps<I> = Partial<Record<string, any>>;
