...
def async_handle_backend_errors(
    ...
    *,
    reraise: bool = False,
    log_level: int = logging.ERROR,
) -> Callable[[Callable[..., CoroutineType[Any, Any, R]]], Callable[..., CoroutineType[Any, Any, R]]]:
    """Async version of handle_backend_errors."""
    def decorator(func: Callable[..., CoroutineType[Any, Any, R]]) -> Callable[..., CoroutineType[Any, Any, R]]:
