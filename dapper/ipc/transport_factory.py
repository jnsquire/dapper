...
class TransportFactory:
    ...
    @staticmethod
    def create_unix_listener_socket(path: str | None = None) -> tuple[_socket.socket, list[str], Path]:
    ...
    @staticmethod
    def create_pipe_listener_sync(pipe_name: str | None = None) -> tuple[mp_conn.Listener | None, list[str]]:
