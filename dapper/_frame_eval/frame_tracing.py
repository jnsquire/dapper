...
class FrameEvaluator:
    ...
    def should_skip_frame(self, frame: FrameType) -> bool:
        ...
        if self.path_handler.is_standard_library_path(filename, self.config.standard_library_paths):
            return True
    ...
    def is_debugger_frame(self, frame: FrameType) -> bool:
        ...
        if self.path_handler.is_debugger_path(filename, self.config.debugger_paths[:4]):  # Only core debugger paths
            return True
