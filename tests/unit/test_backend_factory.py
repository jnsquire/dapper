...
class TestBackendFactory:
    ...
    def test_create_backend_strategy_error(self) -> None:
        ...
        class FailingStrategy:
            ...
            def create_backend(self, config: DapperConfig, loop: asyncio.AbstractEventLoop, **kwargs):  # noqa: ARG002
...
class TestGlobalFunctions:
    ...
    def test_register_backend_strategy_global(self) -> None:
        ...
        class MockStrategy:
            ...
            def create_backend(self, config: DapperConfig, loop: asyncio.AbstractEventLoop, **kwargs) -> "DebuggerBackend":  # noqa: ARG002
                # Return a mock backend that satisfies the protocol
                class MockBackend:
                    def is_available(self) -> bool:
                        return False
