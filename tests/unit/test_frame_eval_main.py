...
class TestFrameEvalMain:
    ...
    def test_check_platform_compatibility(self):
        ...
        with (
            ...
            assert self.manager._check_platform_compatibility() is True  # 32-bit is in SUPPORTED_ARCHITECTURES
...
def test_setup_frame_eval():
    ...
    with patch.object(manager, "_validate_config", return_value=True), \
