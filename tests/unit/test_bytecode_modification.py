...
def test_inject_breakpoints(original_code: types.CodeType) -> None:
    ...
    success, modified_code = inject_breakpoint_bytecode(
        original_code, breakpoint_lines
    )
    assert success
...
def test_breakpoint_injection(bytecode_modifier: BytecodeModifier, original_code: types.CodeType) -> None:
...
def test_optimization_toggle(bytecode_modifier: BytecodeModifier, original_code: types.CodeType) -> None:
...
def test_injection_point_finding(bytecode_modifier: BytecodeModifier, original_code: types.CodeType) -> None:
