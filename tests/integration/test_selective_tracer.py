...
class TestFrameAnalyzer:
    ...
    def test_should_trace_frame_with_breakpoints(self):
        ...
        with patch("dapper._frame_eval.selective_tracer.get_breakpoints") as mock_get_breakpoints:
            ...
            # Verify the result
            assert result["should_trace"] is True, f"Expected should_trace to be True, got {result['should_trace']}. Reason: {result['reason']}"
    ...
    def test_get_statistics(self):
        ...
        expected_keys = ["total_frames", "traced_frames", "cache_hits", "fast_path_hits", "trace_rate", "cache_size"]
...
class TestTraceManager:
    ...
    def test_trace_function_integration(self):
        ...
        # Mock the analyzer to always return True for should_trace_frame
        with patch.object(self.trace_manager.dispatcher.analyzer, "should_trace_frame") as mock_should_trace:
            mock_should_trace.return_value = {
                "should_trace": True,
                "reason": "breakpoint_on_line",
                "breakpoint_lines": {10},
...
class TestThreadSafety:
    ...
    def test_concurrent_breakpoint_updates(self):
        ...
        for i in range(5):
            assert self.trace_manager.get_breakpoints(f"test_{i}.py") == {i*10, i*10+5, i*10+9}
